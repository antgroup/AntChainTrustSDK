...
/**
 * @file security.c
 * @brief Linux platform security adapter implementation
 *
 ...
 * It does not provide hardware-backed confidentiality, anti-tamper protection,
 * rollback protection, or non-exportable private-key storage. Products that
 * need to protect private keys must replace or extend this adapter with the
 * target platform's actual TEE, secure element, TPM, or equivalent secure
